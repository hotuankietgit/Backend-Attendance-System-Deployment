    ...
    constructor() {
        ...
        this.uploadClasses = (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let { studentClasses, studentDetails, error } = yield ExcelService_1.default.readStudentsInClassFromExcel(fileExcel, classID);
                if (error) {
                    return res.status(503).json({ message: error });
                }
                ...
                if (yield StudentClassService_1.default.uploadClass(classes, studentClasses)) {
        ...
        this.uploadMoreStudentsToClass = (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const fileExcel = req.files.file;
                let { studentClasses: data, studentDetails, error } = yield ExcelService_1.default.readStudentsInClassFromExcel(fileExcel, classID);
                if (error) {
                    return res.status(503).json({ message: error });
                }
                if (data.length == 0) {
        ...
        this.getClasses = (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let { data, error } = (semesterID) ? yield ClassService_1.default.getClassesBySemester(semesterID) : yield ClassService_1.default.getClasses();
                if (error) {
                    return res.status(503).json({ message: error });
                }
                if (data.length == 0) {
        ...
        this.getCoursesWithPagination = (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let { data: total, error: nopage } = yield CourseService_1.default.getCourses();
        ...
        this.getClassesByCourseIDWithPagination = (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let { data: total, error: nopage } = yield ClassService_1.default.getClassesWithCourseAndTeacherByCourseID(courseID);
                console.log(total);
                if (nopage || total.length == 0) {
                    total = 0;
                }
        ...
        this.getClassesWithPagination = (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                let page = req.params.page;
                let semesterID = req.query.semester;
                let { data, error } = (semesterID) ? yield ClassService_1.default.getClassesWithPaginationAndSemester(page, semesterID) : yield ClassService_1.default.getClassesWithPagination(page);
                let { data: total, error: nopage } = (semesterID) ? yield ClassService_1.default.getClassesBySemester(semesterID) : yield ClassService_1.default.getClasses();
                if (nopage || total.length == 0) {
                    total = 0;
                }
                else {
        ...
        this.getTotalStatsHomePage = (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                let totalStudents = yield StudentService_1.default.getTotalStudents();
                let totalTeachers = yield TeacherService_1.default.getTotalTeachers();
                let totalClasses = yield ClassService_1.default.getTotalClasses();
                let totalCourses = yield CourseService_1.default.getTotalCourses();
