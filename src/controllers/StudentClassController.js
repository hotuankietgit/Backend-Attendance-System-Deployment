    ...
    constructor() {
        ...
        this.getClassesByStudentID = (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let { data, error } = yield StudentClassService_1.default.getClassesByStudentID(studentID, semesterID, archived);
                if (error) {
                    return res.status(500).json({ message: error });
                }
                if (data.length == 0) {
        ...
        this.uploadStudentClass = (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let studentClasses = BusinessUtils_1.default.generateStudentClassFromExcel(worksheet, semesterID);
                if (yield StudentClassService_1.default.uploadStudentsInClass(studentClasses)) {
                    return res.status(200).json(studentClasses);
                }
