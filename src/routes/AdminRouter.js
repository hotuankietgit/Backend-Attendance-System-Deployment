...
AdminRouter.get("/home", verifyAccessToken_1.default, (0, Authorization_1.default)('admin'), AdminController_1.default.getTotalStatsHomePage);
...
AdminRouter.get("/classes/:id/stats", verifyAccessToken_1.default, (0, Authorization_1.default)('admin'), AttendanceDetailController_1.default.getTotalStatsByClassIDForAdmin);
//semester
AdminRouter.get("/semester", verifyAccessToken_1.default, (0, Authorization_1.default)("admin"), SemesterController_1.default.getAllSemester);
AdminRouter.post("/semester/submit", verifyAccessToken_1.default, (0, Authorization_1.default)("admin"), SemesterController_1.default.addSemester);
AdminRouter.put("/semester/:id", verifyAccessToken_1.default, (0, Authorization_1.default)("admin"), SemesterController_1.default.editSemester);
AdminRouter.delete("/semester/:id", verifyAccessToken_1.default, (0, Authorization_1.default)("admin"), SemesterController_1.default.deleteSemester);
AdminRouter.delete("/semester", verifyAccessToken_1.default, (0, Authorization_1.default)("admin"), SemesterController_1.default.deleteAllSemester);
//import
AdminRouter.post("/class/submit", verifyAccessToken_1.default, (0, Authorization_1.default)("admin"), ClassesController_1.default.uploadClasses);
AdminRouter.post("/studentclass/submit", verifyAccessToken_1.default, (0, Authorization_1.default)("admin"), StudentClassController_1.default.uploadStudentClass);
