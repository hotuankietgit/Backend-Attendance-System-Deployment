...
TeacherRouter.post("/form/submit", verifyAccessToken_1.default, (0, Authorization_1.default)("teacher"), AttendanceFormController_1.default.activateAttendanceForm);
...
TeacherRouter.get("/classes/:id/stats", verifyAccessToken_1.default, (0, Authorization_1.default)('teacher'), AttendanceDetailController_1.default.getTotalStatsByClassIDForTeacher);
TeacherRouter.get("/semester", verifyAccessToken_1.default, (0, Authorization_1.default)("teacher"), SemesterController_1.default.getAllSemester);
TeacherRouter.put("/classes/archives/:classid", verifyAccessToken_1.default, (0, Authorization_1.default)('teacher'), ClassesController_1.default.editClassInArchivesByClassID);
