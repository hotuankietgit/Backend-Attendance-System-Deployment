...
TestAPIRouter.post("/import", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        let classes = BusinessUtils_1.default.generateClassesFromExcel(worksheet, "1");
        //await classRepository.insert(classes);
        let attendanceForms = classes.flatMap(c => c.attendanceForm);
        console.log(classes);
        yield classRepository.insert(classes);
        yield attendanceFormRepository.insert(attendanceForms);
        // console.log(classes);
