...
class AttendanceDetailService {
    constructor() {
        ...
        this.getStatsBasedOnClassID = (classID) => __awaiter(this, void 0, void 0, function* () {
            try {
                let data = yield attendanceFormRepository.createQueryBuilder('attendanceform').
                    innerJoinAndMapMany("attendanceform.attendancedetails", AttendanceDetail_1.AttendanceDetail, "attendancedetail", "attendancedetail.formID = attendanceform.formID").
