...
class AttendanceFormService {
    constructor() {
        //Oke
        this.createFormTransaction = (attendanceForm, attendanceDetails, isFormInUse) => __awaiter(this, void 0, void 0, function* () {
            try {
                yield db_config_1.AppDataSource.transaction((transactionalEntityManager) => __awaiter(this, void 0, void 0, function* () {
                    yield transactionalEntityManager.update(AttendanceForm_1.AttendanceForm, { formID: attendanceForm.formID }, {
        ...
        //Oke
        this.createFormEntity = (attendanceForm, classes, startTime, endTime, dateOpen, type, location, latitude, longitude, radius) => {
        ...
        this.closeOrOpenFormByFormID = (formID, status) => __awaiter(this, void 0, void 0, function* () {
            try {
                yield attendanceFormRepository.update({ formID: formID }, { status: status });
                return true;
            }
            catch (e) {
                return false;
