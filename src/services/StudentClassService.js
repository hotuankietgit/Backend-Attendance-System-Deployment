...
class StudentClassService {
    constructor() {
        ...
        // }
        //oke used in studentcontroller
        this.getClassesByStudentID = (studentID, semesterID, archived) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                // where("student_class.studentID = :id", {id : studentID}).
                // getRawMany();
                let datenow = (0, TimeConvert_1.JSDatetimeToMySQLDatetime)(new Date());
                ...
                let data = yield studentClassRepository.createQueryBuilder("student_class").
                    innerJoinAndMapOne('student_class.classDetail', Classes_1.Classes, 'classes', queryFilterArchived).
                    innerJoinAndMapMany("classes.attendanceform", AttendanceForm_1.AttendanceForm, "attendanceform", "attendanceform.classID = classes.classID").
