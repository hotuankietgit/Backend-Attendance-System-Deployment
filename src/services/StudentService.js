...
const StudentDetailDTO_1 = __importDefault(require("../dto/StudentDetailDTO"));
    ...
    constructor() {
        ...
        this.searchStudent = (studentID) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (data) {
                    data = StudentDetailDTO_1.default.studentDetail(data);
                }
                return { data: data, error: null };
            }
            catch (e) {
        ...
        this.getTotalStudents = () => __awaiter(this, void 0, void 0, function* () {
            try {
